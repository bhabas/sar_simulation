...
ax_Thrust_Constant.plot(temp_vals,quadratic_func(temp_vals,k_f),color="grey",linestyle="--",label=r"Quadratic Fit: $F_t = k_f \cdot \omega^2$",zorder=0)
...
ax_Torque_Constant.plot(temp_vals,quadratic_func(temp_vals,k_t),color="grey",linestyle="--",label=r"Quadratic Fit: $T_t = k_t \cdot \omega^2$",zorder=0)
...
ax_Thrust_Cmd.set_ylim(-200,2500)
