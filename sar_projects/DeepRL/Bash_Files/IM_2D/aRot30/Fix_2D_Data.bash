...
python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    ...
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/A1/IM_A1_0deg_S2D.json \
    --S3_Upload true
...
python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/0deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/B1/IM_B1_0deg_S2D.json \
    --S3_Upload true
...
python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/0deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/D1/IM_D1_0deg_S2D.json \
    --S3_Upload true

python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/0deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/D2/IM_D2_0deg_S2D.json \
    --S3_Upload true
...
python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    ...
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/A1/IM_A1_45deg_S2D.json \
    --S3_Upload true

python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/45deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/A2/IM_A2_45deg_S2D.json \
    --S3_Upload true

python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/45deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/B1/IM_B1_45deg_S2D.json \
    --S3_Upload true
...
python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/45deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/D1/IM_D1_45deg_S2D.json \
    --S3_Upload true

python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/45deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/D2/IM_D2_45deg_S2D.json \
    --S3_Upload true
...
python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    ...
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/A1/IM_A1_90deg_S2D.json \
    --S3_Upload true

python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/90deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/A2/IM_A2_90deg_S2D.json \
    --S3_Upload true

python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/90deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/B1/IM_B1_90deg_S2D.json \
    --S3_Upload true
...
python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/90deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/D1/IM_D1_90deg_S2D.json \
    --S3_Upload true

python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/90deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/D2/IM_D2_90deg_S2D.json \
    --S3_Upload true
...
python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    ...
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/A1/IM_A1_135deg_S2D.json \
    --S3_Upload true

python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/135deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/A2/IM_A2_135deg_S2D.json \
    --S3_Upload true

python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/135deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/B1/IM_B1_135deg_S2D.json \
    --S3_Upload true
...
python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/135deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/D1/IM_D1_135deg_S2D.json \
    --S3_Upload true

python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/135deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/D2/IM_D2_135deg_S2D.json \
    --S3_Upload true
...
python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    ...
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/A1/IM_A1_180deg_S2D.json \
    --S3_Upload true

python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/180deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/A2/IM_A2_180deg_S2D.json \
    --S3_Upload true

python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/180deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/B1/IM_B1_180deg_S2D.json \
    --S3_Upload true
...
python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/180deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/D1/IM_D1_180deg_S2D.json \
    --S3_Upload true

python $DEEP_RL_PATH/T4.5_Data_Fix.py \
    --GroupName IM_2D_aRot30/180deg \
    --TrainConfig $DEEP_RL_PATH/Config_Files/IM_2D_Sim/aRot30/D2/IM_D2_180deg_S2D.json \
    --S3_Upload true
