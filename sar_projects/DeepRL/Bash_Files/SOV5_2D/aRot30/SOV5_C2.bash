...
python $DEEP_RL_PATH/T2_Policy_FineTuning.py \
    ...
    --PT_TrainConfig $DEEP_RL_PATH/Config_Files/SOV5_2D_Sim/aRot60/C2/SOV5_C2_45deg_S2D.json \
    --t_step_load 150000 \
    --S3_Upload true && \
...
python $DEEP_RL_PATH/T2_Policy_FineTuning.py \
    ...
    --PT_TrainConfig $DEEP_RL_PATH/Config_Files/SOV5_2D_Sim/aRot60/C2/SOV5_C2_90deg_S2D.json \
    --t_step_load 150000 \
    --S3_Upload true && \
...
python $DEEP_RL_PATH/T2_Policy_FineTuning.py \
    ...
    --PT_TrainConfig $DEEP_RL_PATH/Config_Files/SOV5_2D_Sim/aRot60/C2/SOV5_C2_135deg_S2D.json \
    --t_step_load 150000 \
    --S3_Upload true && \
...
python $DEEP_RL_PATH/T2_Policy_FineTuning.py \
    ...
    --PT_TrainConfig $DEEP_RL_PATH/Config_Files/SOV5_2D_Sim/aRot60/C2/SOV5_C2_180deg_S2D.json \
    --t_step_load 150000 \
    --S3_Upload true && \
...
python $DEEP_RL_PATH/T2_Policy_FineTuning.py \
    ...
    --PT_TrainConfig $DEEP_RL_PATH/Config_Files/SOV5_2D_Sim/aRot60/C2/SOV5_C2_0deg_S2D.json \
    --t_step_load 150000 \
    --S3_Upload true && \
