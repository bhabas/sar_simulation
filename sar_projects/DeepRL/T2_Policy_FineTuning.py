...
parser.add_argument('--PT_Config',      help='Path to pretrained config file', required=True)
...
with open(args.PT_Config, 'r') as PreTrainConfig_File:
...
if __name__ == '__main__':
    ...
    RL_Manager.load_model(
        ...
        LogName=PreTrainConfig['LogName'],
