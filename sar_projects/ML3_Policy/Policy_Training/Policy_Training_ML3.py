...
class Policy_Trainer():
    ...
    def createScaler(self,X):
        ...
        ## SAVE SCALER TO FILE 
        np.savetxt(f"{BASEPATH}/crazyflie_projects/ML3_Policy/Policy_Training/Info/Scaler_{self.model_initials}.csv",
    ...
    def loadScaler(self):
        ...
        arr = np.loadtxt(
            open(f"{BASEPATH}/crazyflie_projects/ML3_Policy/Policy_Training/Info/Scaler_{self.model_initials}.csv", "rb"),
            delimiter=",",
            skiprows=1)
...
if __name__ == "__main__":
    ...
    # fileName = "ML3--NL_3.00_45.00_10-27_11:06" + ".csv"
