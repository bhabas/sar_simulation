...
void GazeboMotorModel::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf) {
  ...
  gzmsg<<"!!!!! Entering GazeboMotorModel::Load !!!!!\n";
  model_ = _model;
...
void GazeboMotorModel::UpdateForcesAndMoments() {
  ...
  double force = real_motor_velocity * real_motor_velocity * 2.21e-8; // Kf for Geometric Tracking Controller
  
  // DO SOME WEIRD STUFF TO LIMIT THRUST AT HIGH SPEEDS (THIS IS TURNED OFF)
  ...
  // I'M NOT SURE WHAT THIS IS SO IT IS TURNED OFF
  ...
  // TURN OFF AIR DRAG APPLIED TO LINK 
  // Apply air_drag to link.
  // link_->AddForce(air_drag);
  
  
  // CONVERT MOTOR THRUST TO THE RESULTING YAW MOMENT
  ...
  // drag_torque_parent_frame.Set(0,0,0);
  // parent_links.at(0)->AddRelativeTorque(drag_torque_parent_frame);


  // I'M NOT SURE ON WHAT THIS IS BUT IT IS TURNED OFF
