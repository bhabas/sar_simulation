...
dataPath = "/home/bhabas/catkin_ws/src/crazyflie_simulation/src/crazyflie_rl/src/log/Wide-Short_2-Policy/"
df_list = []
...
master_df.to_csv('WS_2-Policy_Summary.csv',index=False)