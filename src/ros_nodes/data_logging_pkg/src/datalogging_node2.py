...
class DataLoggingNode:
    def __init__(self):
        ...
        self.RLSub = rospy.Subscriber("/rl_data",RLData,self.rl_dataCallback)
        self.StateSub = rospy.Subscriber("/global_state",GlobalState,self.global_stateCallback)
        self.CtrlSub = rospy.Subscriber("/ctrl_data",CtrlData,self.ctrl_dataCallback)
    ...
    def ctrl_dataCallback(self,ctrl_msg):
