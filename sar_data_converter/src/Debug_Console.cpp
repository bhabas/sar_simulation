...
void SAR_DataConverter::ConsoleLoop() // MAIN CONTROLLER LOOP
{
    ...
    while(true) {
        ...
        mvprintw(4, 0,"==== Flags ====");
        mvprintw(5, 0,"Motorstop:\t%u  Flip_flag:\t  %u  Pos Ctrl:\t    %u  Cam_Est:\t  %u",Motorstop_Flag, flip_flag, Pos_Ctrl_Flag,Camera_Sensor_Active);
        ...
        mvprintw(18, 0,"Tau:     % 7.3f  \u03B8x:    % 7.3f  \u03B8y:    % 7.3f",Tau,Theta_x,Theta_y);
        mvprintw(19, 0,"Tau_est: % 7.3f  \u03B8x_est: % 7.3f  \u03B8y_est: % 7.3f",Tau_est,Theta_x_est,Theta_y_est);
        mvprintw(20, 0,"D_perp:  % 7.3f",D_perp);
