...
namespace gazebo
{
    ...
    {
        gzmsg << "Loading Inertia_Params Plugin\n";
        model_ptr = parent;

        linkName = _sdf->GetElement("bodyName")->Get<std::string>();
        gzmsg << "\t Link Name:\t" << linkName << std::endl;
        link_ptr = model_ptr->GetLink(linkName);
        Inertia_ParamsService = nh.advertiseService("/SAR_Internal/Inertia_Params", &Domain_Randomization_Plugin::UpdateInertia, this);
    ...
    bool Domain_Randomization_Plugin::UpdateInertia(sar_msgs::Inertia_Params::Request &req, sar_msgs::Inertia_Params::Response &res)
    {
