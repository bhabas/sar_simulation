...
ax.scatter(df["OF_y_flip_mean"],df["RREV_threshold"],df["flip_d_mean"],c=df["landing_rate_4_leg"])
graph, = ax.plot(OFy,RREV,d)
...
def update(val):
    ...
    print(vel_slider.val)
    graph.set_data(OFy,RREV)
