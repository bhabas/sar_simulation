...
// MESSAGE INCLUDES
#include "crazyflie_msgs_exp/CF_StateData.h"
#include "crazyflie_msgs_exp/CF_FlipData.h"
#include "crazyflie_msgs_exp/CF_ImpactData.h"
#include "crazyflie_msgs_exp/CF_MiscData.h"
...
class CF_DataConverter
{
    public:
        ...
        CF_DataConverter(ros::NodeHandle* nh)
        {
            ...
            StateData_Pub = nh->advertise<crazyflie_msgs_exp::CF_StateData>("/CF_DC/StateData",1);
            MiscData_Pub =  nh->advertise<crazyflie_msgs_exp::CF_MiscData>("/CF_DC/MiscData",1);
            FlipData_Pub =  nh->advertise<crazyflie_msgs_exp::CF_FlipData>("/CF_DC/FlipData",1);
            ImpactData_Pub = nh->advertise<crazyflie_msgs_exp::CF_ImpactData>("/CF_DC/ImpactData",1);
        }


        // FUNCTION PRIMITIVES
        void log1_Callback(const crazyflie_msgs_exp::GenericLogData::ConstPtr &log1_msg);
    ...
    private:
        ...
        // MESSAGES
        crazyflie_msgs_exp::CF_StateData StateData_msg;
        crazyflie_msgs_exp::CF_FlipData FlipData_msg;
        crazyflie_msgs_exp::CF_ImpactData ImpactData_msg;
        crazyflie_msgs_exp::CF_MiscData MiscData_msg;

};


void CF_DataConverter::log1_Callback(const crazyflie_msgs_exp::GenericLogData::ConstPtr &log1_msg)
{
